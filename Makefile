...
xpkg.build.provider-cscdm: do.build.images
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/cscdms/03-delete.yaml.tmpl.
